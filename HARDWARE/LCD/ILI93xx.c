...
//拉高VCI PC0
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0;				 //PC0 推挽输出
  ...
  if(lcddev.id<0XFF||lcddev.id==0XFFFF||lcddev.id==0X9300)//读到ID不正确,新增lcddev.id==0X9300判断，因为9341在未被复位的情况下会被读成9300
	...
	{
printf("lcd init \n");				
LCD_WriteReg(0xFF00,0x80);//LCD_WriteReg(0xFF00,0x80);
LCD_WriteReg(0xFF01,0x09);//LCD_WriteReg(0xFF01,0x09);
LCD_WriteReg(0xFF02,0x01);//LCD_WriteReg(0xFF02,0x01);

LCD_WriteReg(0xFF80,0x80);//LCD_WriteReg(0xFF80,0x80);
LCD_WriteReg(0xFF81,0x09);//LCD_WriteReg(0xFF81,0x09);

LCD_WriteReg(0xFF03,0x01);//LCD_WriteReg(0xFF03,0x01);

///////////////////////////////////////
LCD_WriteReg(0xC480,0x30);//LCD_WriteReg(0xC480,0x30); //????
delay_ms(10);//DELAYMS(10);
LCD_WriteReg(0xC48A,0x40);//LCD_WriteReg(0xC48A,0x40); //????
delay_ms(10);//DELAYMS(10);
///////////////////////////////////////

LCD_WriteReg(0xB390,0x02);//LCD_WriteReg(0xB390,0x02);

LCD_WriteReg(0xB392,0x45);//LCD_WriteReg(0xB392,0x45);

LCD_WriteReg(0xC080,0x00);//LCD_WriteReg(0xC080,0x00);
LCD_WriteReg(0xC081,0x58);
LCD_WriteReg(0xC082,0x00);
LCD_WriteReg(0xC083,0x15);
LCD_WriteReg(0xC084,0x15);
LCD_WriteReg(0xC085,0x00);
LCD_WriteReg(0xC086,0x58);
LCD_WriteReg(0xC087,0x15);
LCD_WriteReg(0xC088,0x15);

LCD_WriteReg(0xC090,0x00);
LCD_WriteReg(0xC091,0x44);
LCD_WriteReg(0xC092,0x00);
LCD_WriteReg(0xC093,0x00);
LCD_WriteReg(0xC094,0x00);
LCD_WriteReg(0xC095,0x03);
...
LCD_WriteReg(0xC1A6,0x00);
LCD_WriteReg(0xC1A7,0x00);
LCD_WriteReg(0xC1A8,0x00);

LCD_WriteReg(0xC480,0x30);

LCD_WriteReg(0xC481,0x83);

LCD_WriteReg(0xC489,0x08);

LCD_WriteReg(0xC48A,0x40);

LCD_WriteReg(0xC582,0xA3);

LCD_WriteReg(0xC590,0x96);
LCD_WriteReg(0xC591,0x86);
LCD_WriteReg(0xC592,0x01);

LCD_WriteReg(0xC5B1,0xA9);

LCD_WriteReg(0xCE80,0x87);
LCD_WriteReg(0xCE81,0x03);
LCD_WriteReg(0xCE82,0x00);
LCD_WriteReg(0xCE83,0x86);
LCD_WriteReg(0xCE84,0x03);
LCD_WriteReg(0xCE85,0x00);
LCD_WriteReg(0xCE86,0x85);
LCD_WriteReg(0xCE87,0x03);
LCD_WriteReg(0xCE88,0x00);
LCD_WriteReg(0xCE89,0x84);
LCD_WriteReg(0xCE8A,0x03);
LCD_WriteReg(0xCE8B,0x00);

LCD_WriteReg(0xCE90,0x33);
LCD_WriteReg(0xCE91,0x52);
LCD_WriteReg(0xCE92,0x00);
LCD_WriteReg(0xCE93,0x33);
LCD_WriteReg(0xCE94,0x53);
LCD_WriteReg(0xCE95,0x00);
LCD_WriteReg(0xCE96,0x33);
LCD_WriteReg(0xCE97,0x54);
LCD_WriteReg(0xCE98,0x00);
LCD_WriteReg(0xCE99,0x33);
LCD_WriteReg(0xCE9A,0x55);
LCD_WriteReg(0xCE9B,0x00);
LCD_WriteReg(0xCE9C,0x00);
LCD_WriteReg(0xCE9D,0x00);

LCD_WriteReg(0xCEA0,0x38);
LCD_WriteReg(0xCEA1,0x05);
LCD_WriteReg(0xCEA2,0x03);
LCD_WriteReg(0xCEA3,0x56);
LCD_WriteReg(0xCEA4,0x00);
LCD_WriteReg(0xCEA5,0x00);
LCD_WriteReg(0xCEA6,0x00);
LCD_WriteReg(0xCEA7,0x38);
LCD_WriteReg(0xCEA8,0x04);
LCD_WriteReg(0xCEA9,0x03);
LCD_WriteReg(0xCEAA,0x57);
LCD_WriteReg(0xCEAB,0x00);
LCD_WriteReg(0xCEAC,0x00);
LCD_WriteReg(0xCEAD,0x00);

LCD_WriteReg(0xCEB0,0x38);
LCD_WriteReg(0xCEB1,0x03);
LCD_WriteReg(0xCEB2,0x03);
LCD_WriteReg(0xCEB3,0x58);
LCD_WriteReg(0xCEB4,0x00);
LCD_WriteReg(0xCEB5,0x00);
LCD_WriteReg(0xCEB6,0x00);
LCD_WriteReg(0xCEB7,0x38);
LCD_WriteReg(0xCEB8,0x02);
LCD_WriteReg(0xCEB9,0x03);
LCD_WriteReg(0xCEBA,0x59);
LCD_WriteReg(0xCEBB,0x00);
LCD_WriteReg(0xCEBC,0x00);
LCD_WriteReg(0xCEBD,0x00);

LCD_WriteReg(0xCEC0,0x38);
LCD_WriteReg(0xCEC1,0x01);
LCD_WriteReg(0xCEC2,0x03);
LCD_WriteReg(0xCEC3,0x5A);
LCD_WriteReg(0xCEC4,0x00);
LCD_WriteReg(0xCEC5,0x00);
LCD_WriteReg(0xCEC6,0x00);
LCD_WriteReg(0xCEC7,0x38);
LCD_WriteReg(0xCEC8,0x00);
LCD_WriteReg(0xCEC9,0x03);
LCD_WriteReg(0xCECA,0x5C);
LCD_WriteReg(0xCECB,0x00);
LCD_WriteReg(0xCECC,0x00);
LCD_WriteReg(0xCECD,0x00);

LCD_WriteReg(0xCED0,0x30);
LCD_WriteReg(0xCED1,0x00);
LCD_WriteReg(0xCED2,0x03);
LCD_WriteReg(0xCED3,0x5C);
LCD_WriteReg(0xCED4,0x00);
LCD_WriteReg(0xCED5,0x00);
LCD_WriteReg(0xCED6,0x00);
LCD_WriteReg(0xCED7,0x30);
LCD_WriteReg(0xCED8,0x01);
LCD_WriteReg(0xCED9,0x03);
LCD_WriteReg(0xCEDA,0x5D);
LCD_WriteReg(0xCEDB,0x00);
LCD_WriteReg(0xCEDC,0x00);
LCD_WriteReg(0xCEDD,0x00);

LCD_WriteReg(0xCBC3,0x14);
LCD_WriteReg(0xCBC4,0x14);
LCD_WriteReg(0xCBC5,0x14);
LCD_WriteReg(0xCBC6,0x14);
LCD_WriteReg(0xCBC7,0x14);
LCD_WriteReg(0xCBC8,0x14);
LCD_WriteReg(0xCBC9,0x14);
LCD_WriteReg(0xCBCA,0x14);

LCD_WriteReg(0xCBD8,0x14);
LCD_WriteReg(0xCBD9,0x14);
LCD_WriteReg(0xCBDA,0x14);
LCD_WriteReg(0xCBDB,0x14);
LCD_WriteReg(0xCBDC,0x14);
LCD_WriteReg(0xCBDD,0x14);
LCD_WriteReg(0xCBDE,0x14);

LCD_WriteReg(0xCBE0,0x14);

LCD_WriteReg(0xCC83,0x03);
LCD_WriteReg(0xCC84,0x01);
LCD_WriteReg(0xCC85,0x09);
LCD_WriteReg(0xCC86,0x0B);
LCD_WriteReg(0xCC87,0x0D);
LCD_WriteReg(0xCC88,0x0F);
LCD_WriteReg(0xCC89,0x05);

LCD_WriteReg(0xCC90,0x07);

LCD_WriteReg(0xCC9D,0x04);
LCD_WriteReg(0xCC9E,0x02);

LCD_WriteReg(0xCCA0,0x0A);
LCD_WriteReg(0xCCA1,0x0C);
LCD_WriteReg(0xCCA2,0x0E);
LCD_WriteReg(0xCCA3,0x10);
LCD_WriteReg(0xCCA4,0x06);
LCD_WriteReg(0xCCA5,0x08);

LCD_WriteReg(0xCCB3,0x06);
LCD_WriteReg(0xCCB4,0x08);
LCD_WriteReg(0xCCB5,0x0A);
LCD_WriteReg(0xCCB6,0x10);
LCD_WriteReg(0xCCB7,0x0E);
LCD_WriteReg(0xCCB8,0x0C);
LCD_WriteReg(0xCCB9,0x04);

LCD_WriteReg(0xCCC0,0x02);

LCD_WriteReg(0xCCCD,0x05);
LCD_WriteReg(0xCCCE,0x07);

LCD_WriteReg(0xCCD0,0x09);
LCD_WriteReg(0xCCD1,0x0F);
LCD_WriteReg(0xCCD2,0x0D);
LCD_WriteReg(0xCCD3,0x0B);
LCD_WriteReg(0xCCD4,0x03);
LCD_WriteReg(0xCCD5,0x01);

LCD_WriteReg(0xCFC7,0x02);

LCD_WriteReg(0xD800,0x6F);
LCD_WriteReg(0xD801,0x6F);

LCD_WriteReg(0xD900,0x42);

LCD_WriteReg(0xE100,0x06);
LCD_WriteReg(0xE101,0x0A);
LCD_WriteReg(0xE102,0x11);
LCD_WriteReg(0xE103,0x0F);
LCD_WriteReg(0xE104,0x0A);
LCD_WriteReg(0xE105,0x1F);
LCD_WriteReg(0xE106,0x0E);
LCD_WriteReg(0xE107,0x0D);
LCD_WriteReg(0xE108,0x00);
LCD_WriteReg(0xE109,0x04);
LCD_WriteReg(0xE10A,0x02);
LCD_WriteReg(0xE10B,0x06);
LCD_WriteReg(0xE10C,0x0E);
LCD_WriteReg(0xE10D,0x1F);
LCD_WriteReg(0xE10E,0x1C);
LCD_WriteReg(0xE10F,0x12);

LCD_WriteReg(0xE200,0x06);
LCD_WriteReg(0xE201,0x0A);
LCD_WriteReg(0xE202,0x11);
LCD_WriteReg(0xE203,0x0F);
LCD_WriteReg(0xE204,0x0A);
LCD_WriteReg(0xE205,0x1F);
LCD_WriteReg(0xE206,0x0E);
LCD_WriteReg(0xE207,0x0D);
LCD_WriteReg(0xE208,0x00);
LCD_WriteReg(0xE209,0x05);
LCD_WriteReg(0xE20A,0x02);
LCD_WriteReg(0xE20B,0x07);
LCD_WriteReg(0xE20C,0x0E);
LCD_WriteReg(0xE20D,0x20);
LCD_WriteReg(0xE20E,0x1D);
LCD_WriteReg(0xE20F,0x12);

///////////////////////////////////////
LCD_WriteReg(0xC581,0x66); //Auto pump 2x
LCD_WriteReg(0xF5B6,0x06); //VGL_REG timing setting.
///////////////////////////////////////

LCD_WriteReg(0xFF00,0xFF);
LCD_WriteReg(0xFF01,0xFF);
LCD_WriteReg(0xFF02,0xFF);

LCD_WriteReg(0x3500,0x00);
LCD_WriteReg(0x4400,0x01);
LCD_WriteReg(0x4401,0x22);
  
LCD_WriteReg(0x1100,0x00);
delay_ms(120);
LCD_WriteReg(0x2900,0x00);
delay_ms(10);
LCD_WriteReg(0x2C00,0x00);
printf("lcd init exit\n");	
}
  ...
  else if(lcddev.id==0x6818)
	{
		...
		LCD_WR_REG(0xB300); LCD_WR_DATA(0x08);
		LCD_WR_REG(0xB301); LCD_WR_DATA(0x08);
		LCD_WR_REG(0xB302); LCD_WR_DATA(0x08);
		LCD_WR_REG(0xB500); LCD_WR_DATA(0x08);
		LCD_WR_REG(0xB501); LCD_WR_DATA(0x08);
		LCD_WR_REG(0xB502); LCD_WR_DATA(0x08);
		LCD_WR_REG(0xB600); LCD_WR_DATA(0x54);
		LCD_WR_REG(0xB601); LCD_WR_DATA(0x54);
		LCD_WR_REG(0xB602); LCD_WR_DATA(0x54);
		LCD_WR_REG(0xB700); LCD_WR_DATA(0x44);
		LCD_WR_REG(0xB701); LCD_WR_DATA(0x44);
		LCD_WR_REG(0xB702); LCD_WR_DATA(0x44);
		LCD_WR_REG(0xB800); LCD_WR_DATA(0x34);
		LCD_WR_REG(0xB801); LCD_WR_DATA(0x34);
		LCD_WR_REG(0xB802); LCD_WR_DATA(0x34);
		...
		LCD_WR_REG(0xD103); LCD_WR_DATA(0x01);
		LCD_WR_REG(0xD104); LCD_WR_DATA(0x00);
		LCD_WR_REG(0xD105); LCD_WR_DATA(0x15);
		LCD_WR_REG(0xD106); LCD_WR_DATA(0x00);
		LCD_WR_REG(0xD107); LCD_WR_DATA(0x3B);
		LCD_WR_REG(0xD108); LCD_WR_DATA(0x00);
		LCD_WR_REG(0xD109); LCD_WR_DATA(0x6C);
		LCD_WR_REG(0xD10A); LCD_WR_DATA(0x00);
		LCD_WR_REG(0xD10B); LCD_WR_DATA(0xC7);
		LCD_WR_REG(0xD10C); LCD_WR_DATA(0x01);
		LCD_WR_REG(0xD10D); LCD_WR_DATA(0x0D);
		LCD_WR_REG(0xD10E); LCD_WR_DATA(0x01);
		LCD_WR_REG(0xD10F); LCD_WR_DATA(0x61);
		LCD_WR_REG(0xD110); LCD_WR_DATA(0x01);
		LCD_WR_REG(0xD111); LCD_WR_DATA(0x94);
		LCD_WR_REG(0xD112); LCD_WR_DATA(0x01);
		LCD_WR_REG(0xD113); LCD_WR_DATA(0xD4);
		LCD_WR_REG(0xD114); LCD_WR_DATA(0x01);
		LCD_WR_REG(0xD115); LCD_WR_DATA(0xFF);
		LCD_WR_REG(0xD116); LCD_WR_DATA(0x02);
		LCD_WR_REG(0xD117); LCD_WR_DATA(0x3C);
		LCD_WR_REG(0xD118); LCD_WR_DATA(0x02);
		LCD_WR_REG(0xD119); LCD_WR_DATA(0x69);
		LCD_WR_REG(0xD11A); LCD_WR_DATA(0x02);
		LCD_WR_REG(0xD11B); LCD_WR_DATA(0x6A);
		LCD_WR_REG(0xD11C); LCD_WR_DATA(0x02);
		LCD_WR_REG(0xD11D); LCD_WR_DATA(0x90);
		LCD_WR_REG(0xD11E); LCD_WR_DATA(0x02);
		LCD_WR_REG(0xD11F); LCD_WR_DATA(0xB5);
		LCD_WR_REG(0xD120); LCD_WR_DATA(0x02);
		LCD_WR_REG(0xD121); LCD_WR_DATA(0xCB);
		LCD_WR_REG(0xD122); LCD_WR_DATA(0x02);
		LCD_WR_REG(0xD123); LCD_WR_DATA(0xE2);
		LCD_WR_REG(0xD124); LCD_WR_DATA(0x02);
		LCD_WR_REG(0xD125); LCD_WR_DATA(0xF2);
		LCD_WR_REG(0xD126); LCD_WR_DATA(0x03);
		LCD_WR_REG(0xD127); LCD_WR_DATA(0x04);
		LCD_WR_REG(0xD128); LCD_WR_DATA(0x03);
		LCD_WR_REG(0xD129); LCD_WR_DATA(0x11);
		LCD_WR_REG(0xD12A); LCD_WR_DATA(0x03);
		LCD_WR_REG(0xD12B); LCD_WR_DATA(0x21);
		LCD_WR_REG(0xD12C); LCD_WR_DATA(0x03);
		LCD_WR_REG(0xD12D); LCD_WR_DATA(0x2D);
		LCD_WR_REG(0xD12E); LCD_WR_DATA(0x03);
		LCD_WR_REG(0xD12F); LCD_WR_DATA(0x3E);
		LCD_WR_REG(0xD130); LCD_WR_DATA(0x03);
		LCD_WR_REG(0xD131); LCD_WR_DATA(0x64);
		LCD_WR_REG(0xD132); LCD_WR_DATA(0x03);
		LCD_WR_REG(0xD133); LCD_WR_DATA(0xFE);
		LCD_WR_REG(0xD200); LCD_WR_DATA(0x00);
		LCD_WR_REG(0xD201); LCD_WR_DATA(0x00);
		LCD_WR_REG(0xD202); LCD_WR_DATA(0x00);
		LCD_WR_REG(0xD203); LCD_WR_DATA(0x01);
		LCD_WR_REG(0xD204); LCD_WR_DATA(0x00);
		LCD_WR_REG(0xD205); LCD_WR_DATA(0x15);
		LCD_WR_REG(0xD206); LCD_WR_DATA(0x00);
		LCD_WR_REG(0xD207); LCD_WR_DATA(0x3B);
		LCD_WR_REG(0xD208); LCD_WR_DATA(0x00);
		LCD_WR_REG(0xD209); LCD_WR_DATA(0x6C);
		LCD_WR_REG(0xD20A); LCD_WR_DATA(0x00);
		LCD_WR_REG(0xD20B); LCD_WR_DATA(0xC7);
		LCD_WR_REG(0xD20C); LCD_WR_DATA(0x01);
		LCD_WR_REG(0xD20D); LCD_WR_DATA(0x0D);
	LCD_WR_REG(0xD20E); LCD_WR_DATA(0x01);
	LCD_WR_REG(0xD20F); LCD_WR_DATA(0x61);
	LCD_WR_REG(0xD210); LCD_WR_DATA(0x01);
	LCD_WR_REG(0xD211); LCD_WR_DATA(0x94);
	LCD_WR_REG(0xD212); LCD_WR_DATA(0x01);
	LCD_WR_REG(0xD213); LCD_WR_DATA(0xD4);
	LCD_WR_REG(0xD214); LCD_WR_DATA(0x01);
	LCD_WR_REG(0xD215); LCD_WR_DATA(0xFF);
	LCD_WR_REG(0xD216); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD217); LCD_WR_DATA(0x3C);
	LCD_WR_REG(0xD218); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD219); LCD_WR_DATA(0x69);
	LCD_WR_REG(0xD21A); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD21B); LCD_WR_DATA(0x6A);
	LCD_WR_REG(0xD21C); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD21D); LCD_WR_DATA(0x90);
	LCD_WR_REG(0xD21E); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD21F); LCD_WR_DATA(0xB5);
	LCD_WR_REG(0xD220); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD221); LCD_WR_DATA(0xCB);
	LCD_WR_REG(0xD222); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD223); LCD_WR_DATA(0xE2);
	LCD_WR_REG(0xD224); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD225); LCD_WR_DATA(0xF2);
	LCD_WR_REG(0xD226); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD227); LCD_WR_DATA(0x04);
	LCD_WR_REG(0xD228); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD229); LCD_WR_DATA(0x11);
	LCD_WR_REG(0xD22A); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD22B); LCD_WR_DATA(0x21);
	LCD_WR_REG(0xD22C); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD22D); LCD_WR_DATA(0x2D);
	LCD_WR_REG(0xD22E); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD22F); LCD_WR_DATA(0x3E);
	LCD_WR_REG(0xD230); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD231); LCD_WR_DATA(0x64);
	LCD_WR_REG(0xD232); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD233); LCD_WR_DATA(0xFE);
	LCD_WR_REG(0xD300); LCD_WR_DATA(0x00);
	LCD_WR_REG(0xD301); LCD_WR_DATA(0x00);
	LCD_WR_REG(0xD302); LCD_WR_DATA(0x00);
	LCD_WR_REG(0xD303); LCD_WR_DATA(0x01);
	LCD_WR_REG(0xD304); LCD_WR_DATA(0x00);
	LCD_WR_REG(0xD305); LCD_WR_DATA(0x15);
	LCD_WR_REG(0xD306); LCD_WR_DATA(0x00);
	LCD_WR_REG(0xD307); LCD_WR_DATA(0x3B);
	LCD_WR_REG(0xD308); LCD_WR_DATA(0x00);
	LCD_WR_REG(0xD309); LCD_WR_DATA(0x6C);
	LCD_WR_REG(0xD30A); LCD_WR_DATA(0x00);
	LCD_WR_REG(0xD30B); LCD_WR_DATA(0xC7);
	LCD_WR_REG(0xD30C); LCD_WR_DATA(0x01);
	LCD_WR_REG(0xD30D); LCD_WR_DATA(0x0D);
	LCD_WR_REG(0xD30E); LCD_WR_DATA(0x01);
	LCD_WR_REG(0xD30F); LCD_WR_DATA(0x61);
	LCD_WR_REG(0xD310); LCD_WR_DATA(0x01);
	LCD_WR_REG(0xD311); LCD_WR_DATA(0x94);
	LCD_WR_REG(0xD312); LCD_WR_DATA(0x01);
	LCD_WR_REG(0xD313); LCD_WR_DATA(0xD4);
	LCD_WR_REG(0xD314); LCD_WR_DATA(0x01);
	LCD_WR_REG(0xD315); LCD_WR_DATA(0xFF);
	LCD_WR_REG(0xD316); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD317); LCD_WR_DATA(0x3C);
	LCD_WR_REG(0xD318); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD319); LCD_WR_DATA(0x69);
	LCD_WR_REG(0xD31A); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD31B); LCD_WR_DATA(0x6A);
	LCD_WR_REG(0xD31C); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD31D); LCD_WR_DATA(0x90);
	LCD_WR_REG(0xD31E); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD31F); LCD_WR_DATA(0xB5);
	LCD_WR_REG(0xD320); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD321); LCD_WR_DATA(0xCB);
	LCD_WR_REG(0xD322); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD323); LCD_WR_DATA(0xE2);
	LCD_WR_REG(0xD324); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD325); LCD_WR_DATA(0xF2);
	LCD_WR_REG(0xD326); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD327); LCD_WR_DATA(0x04);
	LCD_WR_REG(0xD328); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD329); LCD_WR_DATA(0x11);
	LCD_WR_REG(0xD32A); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD32B); LCD_WR_DATA(0x21);
	LCD_WR_REG(0xD32C); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD32D); LCD_WR_DATA(0x2D);
	LCD_WR_REG(0xD32E); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD32F); LCD_WR_DATA(0x3E);
	LCD_WR_REG(0xD330); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD331); LCD_WR_DATA(0x64);
	LCD_WR_REG(0xD332); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD333); LCD_WR_DATA(0xFE);
	LCD_WR_REG(0xD400); LCD_WR_DATA(0x00);
	LCD_WR_REG(0xD401); LCD_WR_DATA(0x00);
	LCD_WR_REG(0xD402); LCD_WR_DATA(0x00);
	LCD_WR_REG(0xD403); LCD_WR_DATA(0x01);
	LCD_WR_REG(0xD404); LCD_WR_DATA(0x00);
	LCD_WR_REG(0xD405); LCD_WR_DATA(0x15);
	LCD_WR_REG(0xD406); LCD_WR_DATA(0x00);
	LCD_WR_REG(0xD407); LCD_WR_DATA(0x3B);
	LCD_WR_REG(0xD408); LCD_WR_DATA(0x00);
	LCD_WR_REG(0xD409); LCD_WR_DATA(0x6C);
	LCD_WR_REG(0xD40A); LCD_WR_DATA(0x00);
	LCD_WR_REG(0xD40B); LCD_WR_DATA(0xC7);
	LCD_WR_REG(0xD40C); LCD_WR_DATA(0x01);
	LCD_WR_REG(0xD40D); LCD_WR_DATA(0x0D);
	LCD_WR_REG(0xD40E); LCD_WR_DATA(0x01);
	LCD_WR_REG(0xD40F); LCD_WR_DATA(0x61);
	LCD_WR_REG(0xD410); LCD_WR_DATA(0x01);
	LCD_WR_REG(0xD411); LCD_WR_DATA(0x94);
	LCD_WR_REG(0xD412); LCD_WR_DATA(0x01);
	LCD_WR_REG(0xD413); LCD_WR_DATA(0xD4);
	LCD_WR_REG(0xD414); LCD_WR_DATA(0x01);
	LCD_WR_REG(0xD415); LCD_WR_DATA(0xFF);
	LCD_WR_REG(0xD416); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD417); LCD_WR_DATA(0x3C);
	LCD_WR_REG(0xD418); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD419); LCD_WR_DATA(0x69);
	LCD_WR_REG(0xD41A); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD41B); LCD_WR_DATA(0x6A);
	LCD_WR_REG(0xD41C); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD41D); LCD_WR_DATA(0x90);
	LCD_WR_REG(0xD41E); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD41F); LCD_WR_DATA(0xB5);
	LCD_WR_REG(0xD420); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD421); LCD_WR_DATA(0xCB);
	LCD_WR_REG(0xD422); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD423); LCD_WR_DATA(0xE2);
	LCD_WR_REG(0xD424); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD425); LCD_WR_DATA(0xF2);
	LCD_WR_REG(0xD426); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD427); LCD_WR_DATA(0x04);
	LCD_WR_REG(0xD428); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD429); LCD_WR_DATA(0x11);
	LCD_WR_REG(0xD42A); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD42B); LCD_WR_DATA(0x21);
	LCD_WR_REG(0xD42C); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD42D); LCD_WR_DATA(0x2D);
	LCD_WR_REG(0xD42E); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD42F); LCD_WR_DATA(0x3E);
	LCD_WR_REG(0xD430); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD431); LCD_WR_DATA(0x64);
	LCD_WR_REG(0xD432); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD433); LCD_WR_DATA(0xFE);
	LCD_WR_REG(0xD500); LCD_WR_DATA(0x00);
	LCD_WR_REG(0xD501); LCD_WR_DATA(0x00);
	LCD_WR_REG(0xD502); LCD_WR_DATA(0x00);
	LCD_WR_REG(0xD503); LCD_WR_DATA(0x01);
	LCD_WR_REG(0xD504); LCD_WR_DATA(0x00);
	LCD_WR_REG(0xD505); LCD_WR_DATA(0x15);
	LCD_WR_REG(0xD506); LCD_WR_DATA(0x00);
	LCD_WR_REG(0xD507); LCD_WR_DATA(0x3B);
	LCD_WR_REG(0xD508); LCD_WR_DATA(0x00);
	LCD_WR_REG(0xD509); LCD_WR_DATA(0x6C);
	LCD_WR_REG(0xD50A); LCD_WR_DATA(0x00);
	LCD_WR_REG(0xD50B); LCD_WR_DATA(0xC7);
	LCD_WR_REG(0xD50C); LCD_WR_DATA(0x01);
	LCD_WR_REG(0xD50D); LCD_WR_DATA(0x0D);
	LCD_WR_REG(0xD50E); LCD_WR_DATA(0x01);
	LCD_WR_REG(0xD50F); LCD_WR_DATA(0x61);
	LCD_WR_REG(0xD510); LCD_WR_DATA(0x01);
	LCD_WR_REG(0xD511); LCD_WR_DATA(0x94);
	LCD_WR_REG(0xD512); LCD_WR_DATA(0x01);
	LCD_WR_REG(0xD513); LCD_WR_DATA(0xD4);
	LCD_WR_REG(0xD514); LCD_WR_DATA(0x01);
	LCD_WR_REG(0xD515); LCD_WR_DATA(0xFF);
	LCD_WR_REG(0xD516); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD517); LCD_WR_DATA(0x3C);
	LCD_WR_REG(0xD518); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD519); LCD_WR_DATA(0x69);
	LCD_WR_REG(0xD51A); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD51B); LCD_WR_DATA(0x6A);
	LCD_WR_REG(0xD51C); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD51D); LCD_WR_DATA(0x90);
	LCD_WR_REG(0xD51E); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD51F); LCD_WR_DATA(0xB5);
	LCD_WR_REG(0xD520); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD521); LCD_WR_DATA(0xCB);
	LCD_WR_REG(0xD522); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD523); LCD_WR_DATA(0xE2);
	LCD_WR_REG(0xD524); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD525); LCD_WR_DATA(0xF2);
	LCD_WR_REG(0xD526); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD527); LCD_WR_DATA(0x04);
	LCD_WR_REG(0xD528); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD529); LCD_WR_DATA(0x11);
	LCD_WR_REG(0xD52A); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD52B); LCD_WR_DATA(0x21);
	LCD_WR_REG(0xD52C); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD52D); LCD_WR_DATA(0x2D);
	LCD_WR_REG(0xD52E); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD52F); LCD_WR_DATA(0x3E);
	LCD_WR_REG(0xD530); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD531); LCD_WR_DATA(0x64);
	LCD_WR_REG(0xD532); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD533); LCD_WR_DATA(0xFE);
	LCD_WR_REG(0xD600); LCD_WR_DATA(0x00);
	LCD_WR_REG(0xD601); LCD_WR_DATA(0x00);
	LCD_WR_REG(0xD602); LCD_WR_DATA(0x00);
	LCD_WR_REG(0xD603); LCD_WR_DATA(0x01);
	LCD_WR_REG(0xD604); LCD_WR_DATA(0x00);
	LCD_WR_REG(0xD605); LCD_WR_DATA(0x15);
	LCD_WR_REG(0xD606); LCD_WR_DATA(0x00);
	LCD_WR_REG(0xD607); LCD_WR_DATA(0x3B);
	LCD_WR_REG(0xD608); LCD_WR_DATA(0x00);
	LCD_WR_REG(0xD609); LCD_WR_DATA(0x6C);
	LCD_WR_REG(0xD60A); LCD_WR_DATA(0x00);
	LCD_WR_REG(0xD60B); LCD_WR_DATA(0xC7);
	LCD_WR_REG(0xD60C); LCD_WR_DATA(0x01);
	LCD_WR_REG(0xD60D); LCD_WR_DATA(0x0D);
	LCD_WR_REG(0xD60E); LCD_WR_DATA(0x01);
	LCD_WR_REG(0xD60F); LCD_WR_DATA(0x61);
	LCD_WR_REG(0xD610); LCD_WR_DATA(0x01);
	LCD_WR_REG(0xD611); LCD_WR_DATA(0x94);
	LCD_WR_REG(0xD612); LCD_WR_DATA(0x01);
	LCD_WR_REG(0xD613); LCD_WR_DATA(0xD4);
	LCD_WR_REG(0xD614); LCD_WR_DATA(0x01);
	LCD_WR_REG(0xD615); LCD_WR_DATA(0xFF);
	LCD_WR_REG(0xD616); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD617); LCD_WR_DATA(0x3C);
	LCD_WR_REG(0xD618); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD619); LCD_WR_DATA(0x69);
	LCD_WR_REG(0xD61A); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD61B); LCD_WR_DATA(0x6A);
	LCD_WR_REG(0xD61C); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD61D); LCD_WR_DATA(0x90);
	LCD_WR_REG(0xD61E); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD61F); LCD_WR_DATA(0xB5);
	LCD_WR_REG(0xD620); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD621); LCD_WR_DATA(0xCB);
	LCD_WR_REG(0xD622); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD623); LCD_WR_DATA(0xE2);
	LCD_WR_REG(0xD624); LCD_WR_DATA(0x02);
	LCD_WR_REG(0xD625); LCD_WR_DATA(0xF2);
	LCD_WR_REG(0xD626); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD627); LCD_WR_DATA(0x04);
	LCD_WR_REG(0xD628); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD629); LCD_WR_DATA(0x11);
	LCD_WR_REG(0xD62A); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD62B); LCD_WR_DATA(0x21);
	LCD_WR_REG(0xD62C); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD62D); LCD_WR_DATA(0x2D);
	LCD_WR_REG(0xD62E); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD62F); LCD_WR_DATA(0x3E);
	LCD_WR_REG(0xD630); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD631); LCD_WR_DATA(0x64);
	LCD_WR_REG(0xD632); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xD633); LCD_WR_DATA(0xFE);
	...
	LCD_WR_REG(0xB500); LCD_WR_DATA(0x6B);
	LCD_WR_REG(0xB700); LCD_WR_DATA(0x77);
	LCD_WR_REG(0xB701); LCD_WR_DATA(0x77);
	LCD_WR_REG(0xB800); LCD_WR_DATA(0x01);
	LCD_WR_REG(0xB801); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xB802); LCD_WR_DATA(0x03);
	LCD_WR_REG(0xB803); LCD_WR_DATA(0x03);
	...
	LCD_WR_REG(0xF002); LCD_WR_DATA(0x52);
	LCD_WR_REG(0xF003); LCD_WR_DATA(0x08);
	LCD_WR_REG(0xF004); LCD_WR_DATA(0x00);//LCD_WR_DATA(0x00);
	LCD_WR_REG(0xF600); LCD_WR_DATA(0x60);
	LCD_WR_REG(0x3500); LCD_WR_DATA(0x00);
	LCD_WR_REG(0x0000); LCD_WR_DATA(0xA0);
